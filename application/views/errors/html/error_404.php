...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            body {background:url('/assets/img/404.png') center no-repeat #fff; background-size: inherit !important;}
            .content {width:100%;text-align:center;position:absolute !important;bottom:10%;left:0px;}
            .content a {display:inline-block;text-decoration:none}
            .content a:hover {opacity:0.7}
            .content a, .content a:hover {color: #737f83;font-size: 14px !important;opacity: 1 !important;width: auto;position: initial !important;}
