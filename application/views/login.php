        ...
        <div class="wrapper">
            <div class="login-form">
                ...
                <div class="box-content">
                    <div class="center"><img src="/assets/img/logo1.png" style="width: 200px;" alt="" /></div>
                    <button type="button" onclick="location.href='https://esia.gosuslugi.ru'" class="btn btn-xs btn-primary full-width">Авторизация через ЕСИА</button>
                    <div class="hr"></div>
